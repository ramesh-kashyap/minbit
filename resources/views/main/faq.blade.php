@include('layouts.mainsite.header')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-xxl-6">
                    <div class="heading__content mb-10 mb-lg-15 text-center">
                        <h3 class="mb-5 mb-lg-6">Anytime faq from our team</h3>
    ...
    <section class="faq pb-120 pt-120 position-relative z-0">
        <div class="animation position-absolute top-0 left-0 w-100 h-100 z-n1">
            <img src="{{asset('')}}main/assets/images/button.png" alt="vector" class="position-absolute pt-6 pt-xl-15 previewShapeRevX d-none d-lg-flex">
            <img src="{{asset('')}}main/assets/images/star30.png" alt="vector" class="position-absolute push_animat end-0 top-0  mt-4 me-xl-20 pe-20 d-none d-xxl-flex">
            <img src="{{asset('')}}main/assets/images/vector21.png" alt="vector" class="position-absolute bottom-0 start-0 pb-11 ps-20 ms-10 d-none d-xxxl-flex ">
        </div>
        <div class="container">
            <div class="row justify-content-center">
            ...
            <div class="row gy-10 justify-content-center align-items-center">
                            ...
                            <div class="accordion-single  cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                                ...
                                <div class="content-area">
                                    <div class="content-body pt-5">
                                        <p>Trading involves buying and selling financial instruments like stocks  advantage of price fluctuations in these {{asset('')}}main/assets.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-single cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                ...
                <div class="col-9 col-sm-8 col-lg-5 col-xxl-6">
                    <div class="faq_thumbs d-flex justify-content-center justify-content-xl-end">
                        <img src="{{asset('')}}main/assets/images/faq.png" alt="image">
                    </div>
                </div>
            </div>
        </div>
