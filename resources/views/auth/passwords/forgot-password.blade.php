            ...
            <div class="row align-items-center justify-content-center justify-content-xl-start">
                ...
                <div class="col-12 col-md-6 col-lg-5 col-xxl-5 offset-xxl-1 text-center ms-xl-auto">
                    <div class="sign__content ms-md-5 ms-xxl-0 pt-120 pb-120">
                        ...
                        <form method="POST" action="{{route('forgot_submit')}}" autocomplete="off" id="frmContactus" class="contact__form mt-8 mt-lg-10  text-start">
                        {{ csrf_field() }}
                            <div class="d-flex flex-column gap-5 gap-lg-6 ">
                                ...
                                <div class="single-input">
                                    <label class="mb-2 nw1-color" for="cpassword">Username</label>
                                    <div class="input-pass">
                                        <input type="text" class="fs-six-up bg_transparent pe-13" name="username" id="cpassword" placeholder="username" required>
