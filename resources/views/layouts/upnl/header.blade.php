    ...
    <div class="dashboard-wrapper">
        ...
        <div id="sidebar" class="">
            ...
            <ul class="main">
                ...
                <li>
                    <a  href="user/invest" class="sidebar-link {{menuActive('user.invest')}}">
                ...
                <li>
                    <a href="{{route('user.DepositHistory')}}" class="sidebar-link {{menuActive('user.DepositHistory')}}">
                        <i class="fal fa-file-medical-alt"></i> Packages History </a>
                </li>
                ...
                <li>
                    <a href="{{route('user.roi-bonus')}}" class="sidebar-link {{menuActive('user.roi-bonus')}}">
                        <i class="far fa-search-dollar"></i> Roi Income </a>
                </li>

                <li>
                    <a href="{{route('user.level-income')}}" class="sidebar-link {{menuActive('user.level-income')}}">
                        <i class="fal fa-layer-group"></i> Leadership Income </a>
                </li>
                ...
                <li>
                    <a href="{{route('user.reward-bonus')}}" class="sidebar-link {{menuActive('user.reward-bonus')}}">
                        <i class="far fa-sack-dollar"></i> Rewards</a>
                </li>
