 ...
 @endif
					                ...
					                <div class="modal__item-input">
					                    ...
					                    <div class="modal__deposit-cover-row">
					                        <input type="password" value="" name="old_password" placeholder="Enter Old Password"  >
                                    ...
                                    <div class="modal__item-input">
					                    ...
					                    <div class="modal__deposit-cover-row">
					                        <input type="password" name="password" type="password" id="password" value="" placeholder="Enter New Password" >
					                        <!-- <span class="modal__copy-btn copy__deposit-amount"></span> -->
					                    </div>
					                </div>
					                ...
					                <div class="modal__item-input">
					                    ...
					                    <div class="modal__deposit-cover-row">
					                        <input type="password"  value="" name="password_confirmation" placeholder="Enter confirm_Password">
					                        <!-- <span class="modal__copy-btn copy__deposit-amount"></span> -->
					                    </div>
					                </div>
