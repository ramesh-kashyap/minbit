<html data-scroll-dir-x="0" data-scroll-dir-y="0">
...
<body class="cabinetPage" style="overflow:hidden;" data-aos-easing="ease-in-out-sine" data-aos-duration="400"
    data-aos-delay="0">
    ...
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ asset('') }}main/images/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('') }}main/images/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('') }}main/images/favicon-16x16.png">
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="">
    <link
        href="https://fonts.googleapis.com/css2?family=Inter:wght@200;300;400;600;700&amp;family=Space+Grotesk:wght@600;700&amp;display=swap"
        rel="stylesheet">
                    ...
                    <div class="sidebar__wrap">
                            ...
                            <button class="menu__close_dashboard d-flex d-xl-none">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#6E6E73" stroke-width="1.5"></path>
                                    <path d="M13.7677 10.2322L10.2322 13.7677M13.7677 13.7677L10.2322 10.2322"
                                        stroke="#6E6E73" stroke-width="1.5" stroke-linecap="round"></path>
                                </svg>
                            </button>
                        </div>
                        ...
                        <ul class="dashboard__menu">
                            ...
                            <li class="" id="mining_page">
                                <a href="{{ route('user.invest') }}" class="sidebar-link ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none">
                                        <path class="stroke_hover"
                                            d="M12 4C15.5488 4 18.4665 6.52713 18.8086 9.76241C20.6853 10.5776 22 12.4665 22 14.6667C22 17.6122 19.6436 20 16.7368 20L6.73684 20C4.12076 20 2 17.851 2 15.2C2 13.1078 3.32099 11.3282 5.16392 10.671C5.15992 10.5811 5.15789 10.4908 5.15789 10.4C5.15789 6.86538 8.22121 4 12 4Z"
                                            stroke="#8B8B9D" stroke-width="1.5"></path>
                                    </svg>
                                    Deposit
                                </a>
                            </li>
                            <li class="" id="mining_page">
                                <a href="{{ route('user.re_invest') }}" class="sidebar-link ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none">
                                        <path class="stroke_hover"
                                            d="M12 4C15.5488 4 18.4665 6.52713 18.8086 9.76241C20.6853 10.5776 22 12.4665 22 14.6667C22 17.6122 19.6436 20 16.7368 20L6.73684 20C4.12076 20 2 17.851 2 15.2C2 13.1078 3.32099 11.3282 5.16392 10.671C5.15992 10.5811 5.15789 10.4908 5.15789 10.4C5.15789 6.86538 8.22121 4 12 4Z"
                                ...
                                <a href="{{ route('user.level-team') }}"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        <path class="stroke_hover"
                                            ...
                                            stroke="#8B8B9D" stroke-width="1.5"></path>
                                        <path class="fill_hover" fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <li>
                                <a href="{{ route('user.profile') }}"
                                    class="sidebar-link {{ menuActive('user.profile') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none">
                                        <path class="stroke_hover"
                                            ...
                                            stroke="#8B8B9D" stroke-width="1.5" stroke-linecap="round"
    ...
    <button onclick="document.getElementById('logout-form').submit();" class="logout-btn">Logout</button>
                            ...
                            <li
                                style="display: flex;/*! padding: 20px; */width: 90%;border-radius: 26px 26px 80px 26px;border: 2px #8b8b9d63 solid;margin: 10px auto;overflow: hidden;">
                                <a href="/affilate" style="width: 100%;height: fit-content;padding: 0;"><img
                                        data-url="MB-300.gif"
                    ...
                    <!-- <div class="mining__row mining__row_sticky d-flex flex-column justify-content-between">
                        ...
                        <div class="mining__item swiper-slide">
                            <div class="mining__percent">
                                <div class="pie"
                                    ...
                                    data-pie-index="1" style="width:200px;height:200px;"><svg role="progressbar"
                                        width="200" height="200" viewBox="0 0 100 100" aria-valuemin="0"
                                        aria-valuemax="100" aria-valuenow="100">
                                        <circle cx="50%" cy="50%" r="42" shape-rendering="geometricPrecision"
                                            fill="none" stroke="#DFDFFF" stroke-width="15"></circle>
                                        <circle cx="50%" cy="50%" r="42" shape-rendering="geometricPrecision"
                                            class="pie-circle-1" fill="none" stroke-width="10" stroke-dashoffset="0"
                                            stroke-dasharray="264" stroke-linecap="round"
                                            style="transform:rotate(-90deg);transform-origin: 50% 50%;" stroke="#9393E8"
                                            data-angel="100"></circle><text class="pie-text-1" x="50%" y="50%"
                                            fill="#000" text-anchor="middle" dy="0.35em" font-size="1.6rem"
                                            font-weight="400">
                                            <tspan class="pie-percent-1">100</tspan>
                        ...
                        <div class="mining__item swiper-slide used__block">
                            <div class="mining__percent">
                                <div class="pie"
                                    data-pie="{ &quot;strokeBottom&quot;: 15, &quot;percent&quot;: 0, &quot;colorSlice&quot;: &quot;#9393E8&quot;, &quot;colorCircle&quot;: &quot;#DFDFFF&quot;, &quot;round&quot;: true }"
                                    data-pie-index="2" style="width:200px;height:200px;"><svg role="progressbar"
                                        width="200" height="200" viewBox="0 0 100 100" aria-valuemin="0"
                                        aria-valuemax="100" aria-valuenow="0">
                                        <circle cx="50%" cy="50%" r="42" shape-rendering="geometricPrecision"
                                            fill="none" stroke="#DFDFFF" stroke-width="15"></circle>
                                        <circle cx="50%" cy="50%" r="42" shape-rendering="geometricPrecision"
                                            class="pie-circle-2" fill="none" stroke-width="10" stroke-dashoffset="264"
                                            stroke-dasharray="264" stroke-linecap="round"
                                            style="transform:rotate(-90deg);transform-origin: 50% 50%;" stroke="#9393E8"
                                            data-angel="0"></circle><text class="pie-text-2" x="50%" y="50%" fill="#000"
                                            text-anchor="middle" dy="0.35em" font-size="1.6rem" font-weight="400">
                                            <tspan class="pie-percent-2">0</tspan>
                                            <tspan class="pie-unit-2">%</tspan>
                                        </text>
                                    </svg></div>
                                <img src="{{ asset('') }}main/images/mining_item_icon2.svg" alt="">
                            </div>
                        ...
                        <div class="mining__item swiper-slide available__block">
                            <div class="mining__percent">
                                <div class="pie"
                                    data-pie="{ &quot;strokeBottom&quot;: 15, &quot;percent&quot;: 100, &quot;colorSlice&quot;: &quot;#9393E8&quot;, &quot;colorCircle&quot;: &quot;#DFDFFF&quot;, &quot;round&quot;: true }"
                                    data-pie-index="3" style="width:200px;height:200px;"><svg role="progressbar"
                                        width="200" height="200" viewBox="0 0 100 100" aria-valuemin="0"
                                        aria-valuemax="100" aria-valuenow="100">
                                        <circle cx="50%" cy="50%" r="42" shape-rendering="geometricPrecision"
                                            fill="none" stroke="#DFDFFF" stroke-width="15"></circle>
                                        <circle cx="50%" cy="50%" r="42" shape-rendering="geometricPrecision"
                                            class="pie-circle-3" fill="none" stroke-width="10" stroke-dashoffset="0"
                                            stroke-dasharray="264" stroke-linecap="round"
                                            style="transform:rotate(-90deg);transform-origin: 50% 50%;" stroke="#9393E8"
                                            data-angel="100"></circle><text class="pie-text-3" x="50%" y="50%"
                                            fill="#000" text-anchor="middle" dy="0.35em" font-size="1.6rem"
                                            font-weight="400">
                                            <tspan class="pie-percent-3">100</tspan>
                                            <tspan class="pie-unit-3">%</tspan>
                                        </text>
                                    </svg></div>
                                <img src="{{ asset('') }}main/images/mining_item_icon2.svg" alt="">
                            </div>
                ...
                <div class="dashboard__wrap dashboard__wrap_mining">
                    ...
                    <script>
                        $(document).ready(function () {
                            ...
                            setInterval(function () {
                                ...
                                var currentTimeString = years + "-" + months + "-" + days + ' ' +
                                    hours + ":" + minutes;
                    ...
                    <div class="d-flex justify-content-between align-items-center dashboard__header">
                        ...
                        <button
                            class="menu__open open_dashboard d-flex d-xl-none align-items-center justify-content-center">
                            <svg width="36" height="32" viewBox="0 0 36 32" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M11.8125 16H24.1875" stroke="#000D1D" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round"></path>
                                <path d="M11.8125 11.5H24.1875" stroke="#000D1D" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M11.8125 20.5H24.1875" stroke="#000D1D" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </button>
                    </div>
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            const closeButton = document.querySelector('.menu__close_dashboard');
